...
## Summary
- 1351 nodes · 3011 edges · 137 communities (61 shown, 76 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 207 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Blockers & Generators|Blockers & Generators]]
- [[_COMMUNITY_Audio Playback Engine|Audio Playback Engine]]
- [[_COMMUNITY_App Entry & Screen Router|App Entry & Screen Router]]
- [[_COMMUNITY_Accessibility & Palette|Accessibility & Palette]]
- [[_COMMUNITY_Bootstrap & Splash|Bootstrap & Splash]]
- [[_COMMUNITY_Level & Trackers|Level & Trackers]]
- [[_COMMUNITY_Score & Stars Tracker|Score & Stars Tracker]]
...
- [[_COMMUNITY_Clock & Frame Stepping|Clock & Frame Stepping]]
- [[_COMMUNITY_Telemetry|Telemetry]]
- [[_COMMUNITY_GDD Documents|GDD Documents]]
- [[_COMMUNITY_Keybind Manager|Keybind Manager]]
- [[_COMMUNITY_Audio System Facade|Audio System Facade]]
- [[_COMMUNITY_Endless Mode|Endless Mode]]
- [[_COMMUNITY_UI Screens & Buttons|UI Screens & Buttons]]
...
## Communities (137 total, 76 thin omitted)

### Community 0 - "Blockers & Generators"
Cohesion: 0.07
Nodes (87): breakLock(), createBlockerByKind(), isLocked(), processBlockersOnClear(), processJellyOnClear(), tickGenerators(), tickUnstables(), cloneBlocker() (+79 more)

### Community 1 - "Audio Playback Engine"
Cohesion: 0.05
Nodes (71): getConfig(), getCtx(), getOrCreateHowl(), loadBuffer(), playBuffer(), playCascade(), playCombo(), playEvent() (+63 more)

### Community 2 - "App Entry & Screen Router"
Cohesion: 0.07
...
### Community 3 - "Accessibility & Palette"
Cohesion: 0.07
Nodes (31): createAccessibilityConfig(), getColourPalette(), getContrastConfig(), getGemColour(), getMotionConfig(), onPrefersReducedMotionChange(), applyBloom(), applyGlowBlur() (+23 more)

### Community 4 - "Bootstrap & Splash"
Cohesion: 0.05
...
### Community 6 - "Score & Stars Tracker"
Cohesion: 0.07
...
### Community 13 - "Keybind Manager"
Cohesion: 0.11
Nodes (3): defaultKeybinds(), eventToKeyCode(), KeybindManager

### Community 15 - "Endless Mode"
Cohesion: 0.16
...
### Community 16 - "UI Screens & Buttons"
Cohesion: 0.13
...
### Community 24 - "Audio Outsource Spec"
Cohesion: 0.15
...
## Knowledge Gaps
- **170 isolated node(s):** `Performance Budget System`, `Atlas Packing System`, `setupResizeHandler (ResizeObserver)`, `createSfxTestPanel (debug DOM panel)`, `UI factory` (+165 more)
...
- **Why does `BoardAnimator` connect `Audio Playback Engine` to `Community 35`, `Level & Trackers`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `AudioBuses` connect `Audio Buses` to `Community 48`, `Community 51`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AudioSystem` connect `Audio System Facade` to `Community 48`, `Community 25`, `Community 51`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
