...
- [[_COMMUNITY_Synth SFX System|Synth SFX System]]
- [[_COMMUNITY_Board Rules & Cascade|Board Rules & Cascade]]
- [[_COMMUNITY_Screen Router & UI|Screen Router & UI]]
- [[_COMMUNITY_Adaptive Music|Adaptive Music]]
- [[_COMMUNITY_Level Spec & Objectives|Level Spec & Objectives]]
- [[_COMMUNITY_Accessibility & Rendering|Accessibility & Rendering]]
- [[_COMMUNITY_Board Renderer|Board Renderer]]
- [[_COMMUNITY_Blocker System|Blocker System]]
- [[_COMMUNITY_Board Creation & Tests|Board Creation & Tests]]
- [[_COMMUNITY_Particle Effects|Particle Effects]]
- [[_COMMUNITY_Debug & Dev Tools|Debug & Dev Tools]]
- [[_COMMUNITY_GDD Documentation|GDD Documentation]]
- [[_COMMUNITY_Visual Filters & Effects|Visual Filters & Effects]]
- [[_COMMUNITY_Telemetry Events|Telemetry Events]]
- [[_COMMUNITY_RNG & Determinism|RNG & Determinism]]
...
- [[_COMMUNITY_UI Factory & Screens|UI Factory & Screens]]
- [[_COMMUNITY_Board & Game Loop Tests|Board & Game Loop Tests]]
...
6. `createBoard()` - 25 edges
7. `AudioBuses` - 24 edges
8. `AudioSystem` - 24 edges
9. `BoardRenderer` - 24 edges
10. `KeybindManager` - 23 edges
...
Cohesion: 0.08
Nodes (22): ScreenRouter, loadLevel(), createCreditsScreen(), createGameHUD(), createLevelCompleteScreen(), createLevelFailScreen(), createLevelSelectCard(), createMainMenuScreen() (+14 more)

### Community 3 - "Adaptive Music"
Cohesion: 0.05
...
### Community 12 - "Visual Filters & Effects"
Cohesion: 0.11
...
Cohesion: 0.17
Nodes (4): AnimationManager, MockColorMatrixFilter, MockContainer, MockGraphics
...
## Knowledge Gaps
- **194 isolated node(s):** `Stats`, `MockColorMatrixFilter`, `MockGraphics`, `MockGraphics`, `MockColorMatrixFilter` (+189 more)
...
- **Are the 7 inferred relationships involving `createGem()` (e.g. with `fillBoardNoMatches()` and `reshuffle()`) actually correct?**
